        ...
        >
          <template #icon>
            <div class="text-6xl mb-4">
              <LockOutlined class="text-red-500" />
            </div>
          </template>
