  ...
  <div class="bg-background min-h-screen">
        ...
        >
          <div class="flex-1 min-w-0">
            <div class="flex items-center">
              <div class="flex-shrink-0 bg-success rounded-md p-2">
                <CheckCircleOutlined class="h-6 w-6 text-white" />
              </div>
              <h1 class="ml-3 text-2xl font-semibold text-primary">
                <span class="text-success">Approved</span> Requisition
                Management
              </h1>
            </div>
            <p class="mt-2 text-sm text-secondary max-w-2xl">
              View and manage all approved cheque requisitions in one
    ...
    <div class="max-w-7xl mx-auto py-6">
          ...
          <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center">
              <div class="flex-shrink-0 bg-green-100 rounded-md p-3">
                <CheckCircleOutlined class="h-6 w-6 text-green-500" />
              </div>
      ...
      <div class="mb-4 flex flex-wrap gap-3 items-center">
        <a-tooltip title="Order all selected items">
          <a-button
      ...
      <div class="bg-card shadow-md rounded-md overflow-hidden">
          ...
          <template #bodyCell="{ column, record }">
            ...
            <template v-if="column.key === 'actions'">
              <div class="flex flex-wrap justify-center gap-1">
                <!-- Order Button -->
                <a-tooltip title="Order this requisition">
                  <a-button
                    type="primary"
                    shape="circle"
                    class="btn-blue"
        ...
        <!-- Empty State -->
        <div
          v-if="!loading && approvedItems.length === 0"
        ...
        >
          ...
          <p class="text-secondary">No requisitions have been approved yet</p>
        </div>
      </div>
    </div>
    ...
    <a-modal
      ...
      title="Edit Approved Requisition"
      :width="720"
      :footer="null"
...
const handleConfirmAction = () => {
  if (confirmModalAction.value === "order" && itemToAction.value) {
    ...
    message.success(
      `Successfully ordered ${selectedRowKeys.value.length} item(s)`
    );
